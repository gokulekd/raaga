    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          child:searchBar_Mymusic(text: Query, onChanged: searchSongs, hintText: "Search Songs")
        ),
        backgroundColor: Color.fromARGB(255, 103, 58, 183),
      ...
      body: 
          ...
          SafeArea(
            ...
            child: InkWell(
              ...
              child: Container(
                margin:
                    EdgeInsets.fromLTRB(_w / 30, _w / 30, _w / 30, 0),
                height: _w / 4.5,
                width: _w,
...
Widget cards(BuildContext context, Animation<double> _animation,
  ...
  return FutureBuilder<List<SongModel>>(
    ...
    builder: (context, item) {
      ...
      return ListView.builder(itemCount: 100, itemBuilder: (context, index) =>  Opacity(
        opacity: _animation.value,
